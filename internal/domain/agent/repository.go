...
type Repository interface {
	...
	GetInstanceByMachineID(ctx context.Context, machineID string) (Instance, error)
	...
	ResetBootstrapToken(ctx context.Context) (string, error)
	...
	ActivateTemporaryTask(ctx context.Context, taskID string, nextStatus TaskStatus, activatedAt time.Time) (Task, error)
