...
func NewGitOpsHandler(
	...
	return &GitOpsHandler{query: query, targets: targets, templateFields: templateFields, fieldCandidates: fieldCandidates, valuesCandidates: valuesCandidates, update: update, authz: authz}
}
